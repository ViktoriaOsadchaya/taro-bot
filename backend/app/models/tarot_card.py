...
from app.models.enums import Arcana, Suit, str_enum
...
class TarotCard(Base):
    ...
    arcana: Mapped[Arcana] = mapped_column(str_enum(Arcana), nullable=False)
    # NULL для старших арканов.
    suit: Mapped[Suit | None] = mapped_column(str_enum(Suit), nullable=True)
